...
export var Text_components = function (_React$Component) {
  ...
  function Text_components() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Text_components.__proto__ || Object.getPrototypeOf(Text_components)).call.apply(_ref, [this].concat(args))), _this), _this.state = { input_txt: "", trans_txt: "" }, _this.requestToTranslate1 = function (event) {
